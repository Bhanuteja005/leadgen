                ...
                <Container>
                    <div className="flex flex-col items-start justify-start md:max-w-[200px]">
                        ...
                        <p className="text-muted-foreground mt-4 text-sm text-start">
                            B2B lead generation powered by Hunter.io, Apollo, and LinkedIn — find verified contacts at any company.
                        </p>
                    </div>
                </Container>
                    ...
                    <div className="md:grid md:grid-cols-2 md:gap-8">
                        <Container delay={0.1} className="h-auto">
                            ...
                            <ul className="mt-4 text-sm text-muted-foreground space-y-4">
                                ...
                                <li className="mt-2">
                                    <Link href="http://localhost:8000/docs" className="link hover:text-foreground transition-all duration-300">
                                        API Docs
                                    </Link>
                                </li>
                                <li className="mt-2">
